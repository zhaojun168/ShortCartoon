...
public abstract class BaseConnector {
	...
	* @return
	...
	public String formatApiUrl(String apiUrl, Object ...param){
		...
		MLog.e(Constants.TAG, "请求URL--->" + apiUrl);
		return apiUrl;
	}
	...
	* @param callback
	 */
	public void AsyncGet(final String url, final String cacheName, final Class<?> json ,final ConnectionCallback callback){
		AsyncIncident incident = new AsyncIncident() {
			...
			public Object incident() {
				...
				MLog.e(Constants.TAG, "请求结果--->" + new String(buffer));
